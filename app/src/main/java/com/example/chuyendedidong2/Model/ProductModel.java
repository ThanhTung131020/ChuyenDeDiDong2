...
public class ProductModel implements Serializable {
    ...
    public ProductModel(int soLuong, String name, String desciption, int price,String img_url,String nameShop) {
        this.name = name;
        this.desciption = desciption;
        this.price = price;
        this.img_url = img_url;
    ...
    public ProductModel(String name, String desciption, int price, String img_url) {
        this.name = name;
        this.desciption = desciption;
        this.price = price;
        this.img_url = img_url;
