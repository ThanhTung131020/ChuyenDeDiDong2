...
//
        ...
        categoryAdapter = new CategoryAdapter(this, categoryModelList, new IclickItemCategoryListener() {
            @Override
        ...
        //rvCat.addOnItemTouchListener(new OnIte);
...
//    }
    ...
    public void creatCategoryList() {
        ...
        categoryModelList.add(new CategoryModel("cat004", "https://img.lovepik.com/original_origin_pic/18/08/12/c92c058b1b97d9006312b26393507fb1.png_wh860.png", "tất cả sản phẩm"));
    }
